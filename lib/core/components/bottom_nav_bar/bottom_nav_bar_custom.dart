...
class CupertinoTabBar extends StatelessWidget implements PreferredSizeWidget {
              ...
              child: Semantics(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: AppColorScheme.instance.primary.withOpacity(0.25), offset: const Offset(5, 0), blurRadius: 13.0)],
            ...
            child: Semantics(
              ...
              child: MouseRegion(
                ...
                child: GestureDetector(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(top: isAndroid ? 0 : 4.0, bottom: 4.0),
                    child: Column(
                      mainAxisAlignment: isAndroid ? MainAxisAlignment.center : MainAxisAlignment.start,
                      children: _buildSingleTabItem(items[index], active, context),
                    ),
                  ),
                ),
              ),
  ...
  List<Widget> _buildSingleTabItem(BottomNavigationBarItem item, bool active, BuildContext context) {
    return <Widget>[
      ...
      if (item.label != null)
        Text(
          ...
          style: context.theme.bottomNavigationBarTheme.selectedLabelStyle?.copyWith(fontSize: 12),
        ),
