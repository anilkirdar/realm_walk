...
class ResponsivenessManager {
  ...
  void setFactorSize(BuildContext context) {
    /// sample width of Iphone X = 375
    const double sampleWidth = 375;
    const double sampleHeight = 812;
    ...
    SizedBoxConst.heightFactor = heightFactorMax1.roundToPrecision(3);
    SizedBoxConst.widthFactor = widthFactorMax1.roundToPrecision(3);

    SizeConst.heightFactor = heightFactorMax1.roundToPrecision(3);
    SizeConst.widthFactor = widthFactorMax1.roundToPrecision(3);

    PaddingConst.heightFactor = heightFactorMax1.roundToPrecision(3);
    PaddingConst.widthFactor = widthFactorMax1.roundToPrecision(3);
  }
}
