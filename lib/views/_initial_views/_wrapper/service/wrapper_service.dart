...
class WrapperService extends IWrapperService with BaseService {
  ...
  Future<CheckServicesModel> checkServices() async {
    ...
    final googleResult = await googleComManager
        .send<CheckServicesModel, CheckServicesModel>(
    ...
    return CheckServicesModel(
      isGoogleComEnabled: googleResult.error?.statusCode == HttpStatus.notFound,

      googleComMessage:
          'statusCode ${googleResult.error?.statusCode}, '
