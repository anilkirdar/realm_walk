...
mixin _$ConnectivityStore on ConnectivityStoreBase, Store {
  late final _$hasConnectionAtom = Atom(
    name: 'ConnectivityStoreBase.hasConnection',
    context: context,
  );
  ...
  late final _$ConnectivityStoreBaseActionController = ActionController(
    name: 'ConnectivityStoreBase',
    context: context,
  );
  ...
  void triggerConnection(bool value) {
    final _$actionInfo = _$ConnectivityStoreBaseActionController.startAction(
      name: 'ConnectivityStoreBase.triggerConnection',
    );
    try {
      return super.triggerConnection(value);
    } finally {
